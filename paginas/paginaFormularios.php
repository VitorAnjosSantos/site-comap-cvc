    ...
    <section class="hero is-success is-fullheight">
            <div class="container has-text-centered">
                <div class="column is-6 is-offset-3">
                    <h3 class="title has-text-black">Formularios</h3>
                    <div class="box">
                    <div id="teste"></div>
                    <form id="formProjetos" method="POST">
                        ...
                        <?php foreach($result as $values){?>
                            ...
                            <div class="row">
                                ...
                                <div class="col checkbox">
                                    <input class="checkbox" name="formulario" id="formulario['<?php $values['id_formulario']?>']" type="radio" value="<?php echo $values['id_formulario'] ?>">
                                </div>
                                <div class="col">
                                    <h4><?php echo $values['id_formulario']; ?></h4>
                                </div>
                                <div class="col">
                        ...
                        <div style="margin-bottom: 10px ">
                            <button class="button btn-primary" type="button" name="novoFormulario" id="novoFormulario" data-toggle="modal" data-target="#novoFormularioModal">
                            + Novo Formulario
                            </button>
                        </div>
...
<div class="modal fade" id="novoFormularioModal" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <h3 class="title has-text-grey">Criar Novo Formulario</h3>
                    <?php
                        if(isset($_SESSION['erro'])):
                    ?>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <strong>ERRO!</strong> Não foi possivel criar o novo formulario, Tente novamente.
                ...
                <div class="box">
                    <form action="../objetos/novoFormulario.php" method="POST">

                        <div class="field">
                            <div class="control">
                                <input name="nome" class="input is-large" placeholder="Novo Formulario" autofocus="" type="text">
                            </div>
                        </div>
